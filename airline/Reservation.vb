...
Public Class Reservation
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Try
            ...
            If (AirwayClass.Text) = "First Class" Then
                query = "SELECT Sector.Source, Sector.Destination, Sector.FirstClassFare FROM Sector INNER JOIN Flights ON Flights.SectorID = Sector.SectorID WHERE FlightNo = @FIND"
            ElseIf (AirwayClass.Text) = "Business Class" Then
                query = "SELECT Sector.Source, Sector.Destination, Sector.BusinessClassFare FROM Sector INNER JOIN Flights ON Flights.SectorID = Sector.SectorID WHERE FlightNo = @FIND"
            ElseIf (AirwayClass.Text) = "Economy Class" Then
                query = "SELECT Sector.Source, Sector.Destination, Sector.EconomyClassFare FROM Sector INNER JOIN Flights ON Flights.SectorID = Sector.SectorID WHERE FlightNo = @FIND"
            End If

            Using cmd As New SqlCommand(query, conn)
                cmd.Parameters.Add(New SqlParameter("@find", SqlDbType.NChar, 10, "FlightNo")).Value = FlightNo.Text
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Try
            conn.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
            conn.Open()

            Dim dt As New DataTable()
            Dim query As String = "SELECT * FROM reservations WHERE PnrNo=@find AND SePassword=@find1"

            Using cmd As New SqlCommand(query, conn)
                cmd.Parameters.Add(New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "PnrNo")).Value = PnrNo.Text
                cmd.Parameters.Add(New SqlParameter("@find1", System.Data.SqlDbType.NChar, 10, "SePassword")).Value = TextBox2.Text
                rdr = cmd.ExecuteReader()
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        End If
        Try
            ' Check if the 'Age' field contains only a numeric value
            Dim ageValue As Integer = Integer.Parse(Age.Text)
        Catch ex As Exception
        ...
        If TextBox3.Text = "Match" Then
            ...
            Try
                ...
                ' Check seat availability and set reservation status
                Dim checkSeatAvailabilityQuery As String = "SELECT CASE WHEN EXISTS (SELECT 1 FROM scheduleflights WHERE FlightNo = @FlightNo AND FlightDate = @TravelDate AND " & AirwayClass.Text & "SeatAvailable > 0) THEN 'Confirmed' ELSE 'waiting list' END"

                Using cmdCheckAvailability As New SqlCommand(checkSeatAvailabilityQuery, conn)
                    cmdCheckAvailability.Parameters.AddWithValue("@FlightNo", FlightNo.Text)
                    cmdCheckAvailability.Parameters.AddWithValue("@TravelDate", TravelDate.Text)
                    Rstatus.Text = cmdCheckAvailability.ExecuteScalar().ToString()
                End Using

                ' Update seat availability
                Dim updateSeatAvailabilityQuery As String = "UPDATE scheduleFlights SET " & AirwayClass.Text & "SeatAvailable = " & AirwayClass.Text & "SeatAvailable - 1 WHERE FlightNo = @FlightNo AND FlightDate = @TravelDate"

                Using cmdUpdateAvailability As New SqlCommand(updateSeatAvailabilityQuery, conn)
                    cmdUpdateAvailability.Parameters.AddWithValue("@FlightNo", FlightNo.Text)
                    cmdUpdateAvailability.Parameters.AddWithValue("@TravelDate", TravelDate.Text)
                    cmdUpdateAvailability.ExecuteNonQuery()
                End Using

                ' Insert reservation details
                Dim insertReservationQuery As String = "INSERT INTO Reservations(PnrNo, FlightNo, TravelDate, Fname, Lname, Age, Gender, Class, SeatPref, MealPref, SSR, Fare, Source, Destination, Rstatus, SePassword) " &
                                                  "VALUES (@PnrNo, @FlightNo, @TravelDate, @Fname, @Lname, @Age, @Gender, @Class, @SeatPref, @MealPref, @SSR, @Fare, @Source, @Destination, @Rstatus, @SePassword)"

                Using cmdInsertReservation As New SqlCommand(insertReservationQuery, conn)
                    cmdInsertReservation.Parameters.AddWithValue("@PnrNo", PnrNo.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@FlightNo", FlightNo.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@TravelDate", TravelDate.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Fname", Fname.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Lname", Lname.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Age", Age.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Gender", Gender.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Class", AirwayClass.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@SeatPref", SeatPref.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@MealPref", MealPref.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@SSR", SSR.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Fare", Fare.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Source", Source.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Destination", Destination.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@Rstatus", Rstatus.Text)
                    cmdInsertReservation.Parameters.AddWithValue("@SePassword", TextBox5.Text)
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim cz As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cp As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cr As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cj As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs1 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs2 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs3 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs4 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs6 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs7 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs8 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs9 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs10 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cz1 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cp1 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cr1 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cj1 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs12 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs21 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs31 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs41 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs51 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs61 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        con.Open()
        Dim cu71 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs81 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs91 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs101 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cz12 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cp12 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cr12 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cj12 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs13 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs22 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs32 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs42 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs52 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs62 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs72 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs82 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs92 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs102 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "PnrNo"))
        ...
        Else
            ...
            Dim cx As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
    ...
    Private Sub confirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Else
           ...
           New SqlCommand(cp)
            ...
            Dim cop As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
    ...
    Private Sub CheckSeatAvailability_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckSeatAvailability.Click
        ...
        If TravelDate.Value.Date.Subtract(Today.Date).Days > 30 Then
            ...
            Exit Sub
        End If
        Dim connectionString As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
