...
Public Class Aircraft
    ...
    Private Sub Aircraft_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        populateAirline()
        Dim con As New SqlConnection
        con.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        con.Open()
        Dim dt As New DataTable
    ...
    Private Sub AirlineName1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AirlineName1.SelectedIndexChanged
        ...
        Dim con As New SqlConnection("Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True")
        con.Open()
    ...
    Private Sub Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Add.Click
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "AirCraftTypeId"))
        ...
        Else
            ...
            Dim ck As String = " Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "AirCraftTypeId"))
        ...
        Else
            ...
            Dim ch As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:\My Learning\Aplikasi\Airline Reservation System\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
            con = New SqlConnection(cp)
